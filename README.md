...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `43.1µs` | `65.8µs` |
| [Day 2](./src/bin/02.rs) | `162.3µs` | `282.7µs` |
| [Day 3](./src/bin/03.rs) | `203.2µs` | `198.1µs` |
| [Day 4](./src/bin/04.rs) | `294.6µs` | `827.3µs` |
| [Day 5](./src/bin/05.rs) | `370.4µs` | `5.1ms` |
